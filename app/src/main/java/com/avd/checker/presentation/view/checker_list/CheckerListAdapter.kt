...
@CheckerListScope
class CheckerListAdapter @Inject constructor() : BaseAdapter<CheckerModel, CheckerViewHolder>() {
    ...
    fun addElement(item: CheckerModel) {
        mElements.add(item)
        notifyItemChanged(mElements.size - 1)
    }
}